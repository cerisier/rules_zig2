...
- External translate-c runfiles are action tools, not Zig module deps; adding them as modules caused duplicate module ownership when multiple C translations were present.
